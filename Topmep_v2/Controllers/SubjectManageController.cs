...
namespace topmeperp.Controllers
{
    public class SubjectManageController : Controller
    {
        ...
        private List<FIN_SUBJECT> SearchSubjectByName(string subjectname, string category)
        {
            if (subjectname != null)
            {
                log.Info("search subject by 名稱 =" + subjectname + ", by 項目類別 =" + category);
                ...
                log.Info("get subject count=" + lstSubject.Count);
                return lstSubject;
            }
            else
            {
        ...
        public String addSubject(FormCollection form)
        {
            ...
            log.Info("Request:SUBJECT_ID=" + s.FIN_SUBJECT_ID);
            return msg;
        }
    }
}
