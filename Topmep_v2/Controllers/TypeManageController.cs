...
namespace topmeperp.Controllers
{
    public class TypeManageController : Controller
    {
        ...
        public ActionResult getSubType()
        {
            ...
            log.Debug("get main type code1=" + typecod1 + ",typecod2=" + typecod2);
        ...
        {
            log.Info("modify mainType" + typeManageModel.MainType.TYPE_DESC);
            log.Info("modify SubType" + Request["item.SUB_TYPE_CODE"]);
            ...
            if (subTypeId != null)
            {
                ...
                {
                    log.Debug("subTypeId=" + subTypeId[i] + ",mainTypeId=" + mainTypeId[i] + ",subTypeCode=" + subTypeCode[i] + ",subTypeDesc=" + subTypeDesc[i]);
