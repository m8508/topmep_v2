...
namespace topmeperp.Controllers
{
    public class DeptManageController : Controller
    {
        ...
        {
            log.Info("criteria dpep_name=" + form.Get("userid"));
        ...
        public String delDepartment(FormCollection form)
        {
            ...
            SYS_USER loginUser = (SYS_USER)Session["user"];
            log.Info("User " + loginUser.USER_ID + " delete departnt :" + depId + ",Name" + form.Get("d_deptName"));
            string msg = "";
            try
            {
        ...
        public string getDept()
        {
            ...
            log.Info("get Dept id=" + deptString);
