...
namespace topmeperp.Controllers
{
    public class InquiryController : Controller
    {
        ...
        public ActionResult Index(FormCollection f)
        {
            ...
            //加入刪除註記 預設 "N"
            List<Topmep.Models.TND_PROJECT_ITEM> lstProject = s.getProjectItem(null, Request["projectid"], Request["textCode1"], Request["textCode2"], Request["SystemMain"], Request["systemSub"], "N");
