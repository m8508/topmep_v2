...
namespace Topmep.Service
{
    ...
    public class UserManage : ContextService
    {
        ...
        public void getAllRole()
        {
            ...
            using (var context = new TopmepEntities())
            {
                try
                {
                    ...
                    log.Debug("get records=" + lstRoles.Count);
                    //將系統所有角色封裝供前端頁面調用
       ...
       　public int addOrUpdateRole(SYS_ROLE role)
        ...
        {
            log.Info("user=" + u.ToString() + ",roleId=" + roleid);
        ...
        public List<SYS_FUNCTION> getFunctions(string roleid)
        {
            ...
            using (var context = new TopmepEntities())
            {
                ...
                log.Debug("function count=" + lstFunction.Count);
            }
            return lstFunction;
        }
        //取得使用者資料
    ...
    public class TypeManageService
    {
        ...
        public TyepManageModel getTypeManageModel(string typecode1, string typecode2)
        {
            ...
            log.Debug("get Main Type Count" + typeManageModel.MainType.TYPE_DESC + ",sub type count" + typeManageModel.SubTypes.Count());
    ...
    public class SystemParameter
    {
        ...
        public static List<SYS_PARA> getSystemPara(string functionid, string fieldid)
        {
            ...
            using (var context = new TopmepEntities())
            {
                ...
                log.Debug("get SYS_PARA Count" + lst.Count + ",functionid=" + functionid + ",fieldid=" + fieldid);
            }
            return lst;
        }
        public static List<SYS_PARA> getSystemPara(string functionid)
        {
            ...
            using (var context = new TopmepEntities())
            {
                ...
                log.Debug("get SYS_PARA Count" + lst.Count + ",functionid=" + functionid);
            }
            return lst;
        }
        ...
        public List<PARA_INDEX> getFieldIndex(string functionId)
        {
            ...
            using (var context = new TopmepEntities())
            {
                log.Debug("sql=" + sql + ",funcionId="+ functionId);
        ...
        public static string UpdateSysPara(List<SYS_PARA> lst)
        {
            using (var context = new TopmepEntities())
            {
                ...
                foreach (SYS_PARA para in lst)
                {
                    ...
                    log.Info("update SYS_PARA=" + para.ToString());
    ...
    public class SubjectManageService
    {
        ...
        {
            log.Debug("get finacial subject item by id=" + itemid);
