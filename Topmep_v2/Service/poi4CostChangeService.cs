...
namespace Topmep.Service
{
    public class poi4CostChangeService : ExcelBase
    {
        ...
        {
            //定義樣板檔案名稱
            templateFile = strTemplatePath + "\\CostChange_Template_v1.xlsx";
            log.Debug("Constroctor!!" + templateFile);
        }
        ...
        public void createExcel(TND_PROJECT project)
        {
            ...
            log.Debug("export excel file=" + outputFile);
        ...
        public void getDataFromExcel(string filpath, string projectId, string formId)
        {
            ...
            log.Debug("project id=" + project.PROJECT_ID + ",project name=" + project.PROJECT_NAME);
            //取得異動單資料
            row = sheet.GetRow(2);
            ...
            log.Debug("FORM id=" + costChangeForm.FORM_ID);
            ConvertExcel2Object();
        }
        //將Excel Row 轉製成物件
        public void ConvertExcel2Object()
        {
            ...
            for (int idxRow = 4; idxRow < sheet.LastRowNum + 1; idxRow++)
            {
                ...
                if (null != cell)
                {
                    ...
                    {
                        log.Warn("Excel Row=" + idxRow + " not UID;");
                ...
                {
                    log.Warn("Excel Row=" + idxRow + " Qty can not covert");
                    log.Error(ex.Message + ":" + ex.StackTrace);
                }
                ...
                if (null != cell)
                {
                    ...
                    {
                        log.Warn("Excel Row=" + idxRow + " Priec can not covert");
                        log.Error(ex.Message + ":" + ex.StackTrace);
                    }
                }
                //複價7
